...
async function processPhotoCard() {
  ...
  // Create recolored photo card and scale it down slightly so head/hair has ample margin
  const recoloredPhotoPng = await sharp(newBuf, {
    raw: { width, height, channels: 4 }
  })
    .trim() // trim surrounding outer padding
    .png()
    .toBuffer();
...
<svg width="1200" height="630" viewBox="0 0 1200 630" xmlns="http://www.w3.org/2000/svg">
  <defs>
    ...
    <clipPath id="photoCardClip">
      <rect x="740" y="100" width="350" height="430" rx="24" />
    </clipPath>
  </defs>
  ...
  <!-- RIGHT COLUMN: UNCROPPED PHOTO CARD WITH MARGIN & ROUNDED CONTAINER -->
  <g>
    <!-- Rounded Container Frame with 3-Color Gradient Stroke -->
    <rect x="738" y="98" width="354" height="434" rx="26" fill="none" stroke="url(#brandGradient)" stroke-width="3.5" />
    
    <g clip-path="url(#photoCardClip)">
      <image href="${photoBase64}" x="740" y="100" width="350" height="430" preserveAspectRatio="xMidYMid meet" />
    </g>
  </g>
</svg>
`;
  ...
  console.log('Perfect og.png generated successfully at:', outputPath);
}
