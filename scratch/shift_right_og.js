...
async function processShiftRightOg() {
  ...
  // Key out blue background, keep Sushant's portrait photo 100% full opacity (NO soft alpha feathering!)
  ...
  // Shift the image to the right: x=755, y=105, width=420, height=465.
  // The right edge of the picture is at x=755+420 = 1175, which extends beyond x=1130 and gets clipped cleanly by #photoRightAlignedClip right container wall!
...
<svg width="1200" height="630" viewBox="0 0 1200 630" xmlns="http://www.w3.org/2000/svg">
  ...
  <g clip-path="url(#photoRightAlignedClip)">
    ...
    <!-- Sushant's Subject Photo shifted right (x=755) so the right edge extends past x=1130 and clips flush against the container wall -->
    <image href="${subjectBase64}" x="755" y="105" width="420" height="465" preserveAspectRatio="xMidYMin meet" />
  </g>
...
`;
  ...
  console.log('Shifted right OG image generated successfully at:', outputPath);
}

processShiftRightOg().catch(console.error);
