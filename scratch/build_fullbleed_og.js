...
async function processFullBleedOg() {
  ...
  // Key out blue background, keep Sushant's photo portrait
  ...
  // SVG Layout:
  // Main container card: x=70, y=60, width=1060, height=510, rx=28 (right edge = 1130)
  // Photo container: x=720 to x=1130 (width 410px, height 510px).
  // Photo container clip path:
  // Top-left: sharp (720, 60)
  // Top-right: rounded rx=28 matching parent card (1130, 60)
  // Bottom-right: rounded rx=28 matching parent card (1130, 570)
  // Bottom-left: rounded rx=24 (720, 570)
  //
  // Path for photo container:
  // M 720,60 L 1102,60 A 28,28 0 0 1 1130,88 L 1130,542 A 28,28 0 0 1 1102,570 L 744,570 A 24,24 0 0 1 720,546 Z
...
<svg width="1200" height="630" viewBox="0 0 1200 630" xmlns="http://www.w3.org/2000/svg">
  ...
  <g clip-path="url(#photoRightAlignedClip)">
    ...
    <!-- Sushant's Subject Photo properly centered & scaled so shoulders and hair fit seamlessly without hard crops -->
    <image href="${subjectBase64}" x="735" y="140" width="370" height="430" preserveAspectRatio="xMidYMin meet" />
  </g>

  <!-- FULL BLEED TOP HORIZONTAL BRAND GRADIENT LINE — PLACED ON TOP OF EVERYTHING ACROSS FULL CONTAINER WIDTH (x=70 to x=1130) -->
  <g>
    <!-- Top rounded clip for full-bleed stroke to match parent card top corners rx=28 -->
    <path d="M 70,60 L 1102,60 A 28,28 0 0 1 1130,88 L 1130,66 L 70,66 Z" fill="url(#brandGradient)" />
  </g>
</svg>
`;
  ...
  console.log('Full Bleed OG image generated successfully at:', outputPath);
}

processFullBleedOg().catch(console.error);
